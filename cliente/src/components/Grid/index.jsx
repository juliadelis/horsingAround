...
import { Card, Container, Item, ItemNome, ItemBanco, Img, CardText, ItemCorrespondente, Botao } from "./style.js";
        ...
        <Container>
            ...
            {cavalos.map((cavalos) =>(
                <Card className="cavalo" key={cavalos.id}>
                    {
                        cavalos.foto && <Img src={`https://res.cloudinary.com/dgjpw8ei8/image/upload/v1682287004/${cavalos.foto}`} alt="imagem" />      
                    }
                     <CardText> 
